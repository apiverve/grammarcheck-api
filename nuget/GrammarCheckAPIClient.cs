...
namespace APIVerve.API.GrammarCheck
{
    ...
    /// <summary>
    /// Client for the GrammarCheck API
    /// </summary>
    public class GrammarCheckAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/grammarcheck";
        ...
        public GrammarCheckAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GrammarCheckAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GrammarCheckAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, GrammarCheckQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(GrammarCheckQueryOptions options)
        {
        ...
        public ResponseObj Execute(GrammarCheckQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(GrammarCheckQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(GrammarCheckQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(GrammarCheckQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(GrammarCheckQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(GrammarCheckQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(GrammarCheckQueryOptions options)
        {
