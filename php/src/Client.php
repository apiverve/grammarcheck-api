...
namespace APIVerve\Grammarcheck;
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/grammarcheck?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/grammarcheck';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\GrammarcheckClient] {$message}\n";
        }
    }
}
