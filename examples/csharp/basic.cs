/*
 * Grammar Check API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Grammar Check API.
 * API Documentation: https://docs.apiverve.com/ref/grammarcheck
 */
...
{
    class GrammarCheckExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/grammarcheck";

        /// <summary>
        /// Make a GET request to the Grammar Check API
        /// </summary>
        static async Task<JsonDocument> CallGrammarCheckAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling Grammar Check API...\n");

            var result = await CallGrammarCheckAPI();
